...
export var object_text := "the clock"
...
var inventory_alt := "res://assets/inventory_images/inventory_clock.png"
...
#	else:
	...
	if GlobalVars.tutorial_active:
		GlobalSignals.emit_signal("button_pressed", "the clockclicked")
