...
export var object_text := "the mirror"
...
var inventory_alt := "res://assets/inventory_images/inventory_mirror.png"
...
#			GlobalSignals.emit_signal("button_pressed", "mirrorremove")
#	else:
