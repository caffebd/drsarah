...
export var object_text := "the glasses"
...
var inventory_alt := "res://assets/inventory_images/inventory_glasses.png"
...
#					the_player = get_parent().get_parent().return_player()
		...
		GlobalSignals.emit_signal("sentence_clear")
		GlobalSignals.emit_signal("speak", "It’s a pair of glasses.")
		if is_on_shelf:
