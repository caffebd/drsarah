...
func save_document(path: String, fields) -> void:
...
#	player_info["current_level"] = level_data
	...
	yield(update_document("EnglishAdventure/"+user_info.id+"/Game/Active", active_data), "completed")
...
func update_new_panels():
	...
	yield(update_document("EnglishAdventure/"+user_info.id+"/Game/NewPanels", panels_data), "completed")
...
#	print (room_items.room_items.mapValue.fields)
	yield(update_document("EnglishAdventure/"+user_info.id+"/Game/"+GlobalVars.current_level,  room_items), "completed")
...
#	player_info["current_level"] = level_data
	...
	yield(update_document("EnglishAdventure/"+user_info.id+"/Game/Player", player_info), "completed")
