...
onready var game_objects = {
	"the fire":$"%FireBtn",
	"the second fire":$"%FireBtn2",
	"the first glass of water":$"%Glass",
	"the second glass of water":$"%Glass2",
	"the push button":$"%PushBtn",
	"the third glass of water":$"%Glass3",
	"the red crystal":$"%PinkCrystal",
	"the third fire":$"%FireBtn3",
...
#
	...
	GlobalVars.active_map = "Mid6MapA"
...
#			_save_game()
		...
		if can_save:
			GlobalSignals.emit_signal("speak", "Yes! A telescope can show you a close up view of the moon.")
