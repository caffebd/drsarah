...
"the lever":$"%Lever",
"the first push button":$"%PushBtn",
"the second push button":$"%PushBtn2",
"the third push button":$"%PushBtn3",
"the ring":$"%Ring",
"the boomerang":$"%Boomerang",
"the green crystal":$"%GreenCystal",
"the red crystal":$"%RedCrystal"
...
#
	...
	GlobalVars.active_map = "Water12MapA"
