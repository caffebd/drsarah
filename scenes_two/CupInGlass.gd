...
var object_text := "cup inside glass box"
...
func _sentence_check(sentence):
	...
	match sentence:
		get:
			GlobalSignals.emit_signal("speak", "I cannot take it. It's inside a box.")
		use:
			GlobalSignals.emit_signal("speak", "You need to get it first.")
		use_on:
			return
		look:
			GlobalSignals.emit_signal("speak", "The cup is inside a glass box.")
		_:
