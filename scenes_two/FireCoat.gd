...
var object_text := "the fireproof coat"
...
var inventory_alt := "res://assets/inventory_images/inventory_coat.png"
...
func _sentence_check(sentence):
	...
	match sentence:
		...
		give:
			...
			GlobalSignals.emit_signal("sentence_clear")
		look:
			GlobalSignals.emit_signal("speak", "A fireproof coat. I can walk through fire wearing this.")
		_:
