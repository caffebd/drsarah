...
export var object_text := "the double push button"
...
export (NodePath) var activate_object_one_path = ""
export (NodePath) var activate_object_two_path = ""
var activate_object_one
var activate_object_two
...
#	connect("mouse_exited", self, "_on_exit")
	if linked_box_path !="":
		...
		needs_fuse = true
	if activate_object_one_path !="":
		activate_object_one = get_node(activate_object_one_path)
	if activate_object_two_path !="":
		activate_object_two = get_node(activate_object_two_path)
...
func set_state(the_state):
	...
	if activate_object_one_path != "" and not first_run:
		activate_object_one.set_state(state)
	if activate_object_two_path != "" and not first_run:
		activate_object_two.set_state(state)
	first_run = false
