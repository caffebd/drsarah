...
var object_text := "the green crystal"
...
var a_text := "a green crystal."

var inventory_alt := "res://assets/inventory_images/Inventory Green Crystal.png"
...
func _sentence_check(sentence):
	...
	match sentence:
		...
		"give the green crystal to the village elder":
		...
		use_on:
			return
		look:
			GlobalSignals.emit_signal("speak", "This is a marvellous green crystal.")
		_:
