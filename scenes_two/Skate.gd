...
var object_text := "the roller skates"
...
var inventory_alt := "res://assets/inventory_images/inventory_skates.png"
...
func _sentence_check(sentence):
	...
	match sentence:
		...
		give:
			...
			GlobalSignals.emit_signal("sentence_clear")
		look:
			GlobalSignals.emit_signal("speak", "A pair of roller skates... they look fast!")
		_:
