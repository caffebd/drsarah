...
onready var shelves = [$"%Shelf",$"%Shelf2" ]
...
onready var game_objects = {
	...
	"the apple": $"%Apple",
	"the creature":$"%SmallCreature",
	"the push button": $"%PushBtn",
	"the door":$"%ButtonDoor",
	"the creature1":$"%SmallCreature2",
	"the creature2":$"%SmallCreature3",
	"the creature3":$"%SmallCreature4",
	"the creature4":$"%SmallCreature5",
	"the creature5":$"%SmallCreature6",
	"the creature6":$"%SmallCreature7",
	"the creature7":$"%SmallCreature8",
	"the creature8":$"%SmallCreature9",
	"the creature9":$"%SmallCreature10"
}
...
onready var spawns = [$Demo4MapA/Spawn1]
var spawn_count = 0
